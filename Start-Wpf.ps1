    ...
    <Grid Grid.Column="1" Margin="34,28,34,28">
      ...
      <Border Grid.Row="2" Background="White" CornerRadius="12" Padding="22"
        ...
        <Grid>
          ...
          <Border Grid.Row="2" Grid.Column="1" Background="#F5F7FA" CornerRadius="8" BorderBrush="#DCE3EC" BorderThickness="1">
          ...
          <Button x:Name="OutputBrowseButton" Grid.Row="2" Grid.Column="2" Content="参照..." Margin="10,1,0,1" Style="{StaticResource BrowseButton}"/>
        </Grid>
      </Border>
...
function Start-Workflow([string]$mode) {
    ...
    } -ArgumentList $workflowPath, $mode, $excelPathBox.Text, $outputPathBox.Text, $defaultReport
    $timer.Start()
}
